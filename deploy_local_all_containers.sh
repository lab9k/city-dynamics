...
pg_restore --host=database --port=5432 --username=citydynamics --dbname=citydynamics --if-exists --clean --no-password importer/data/quantillion_dump/validated_dump_feb.dump
