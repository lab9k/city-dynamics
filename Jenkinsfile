...
node {
    ...
    stage('Test') {
        tryStep "test", {
            sh "docker-compose -p citydynamics -f web/deploy/test/docker-compose.yml build && " +
                    "docker-compose -p citydynamics -f web/deploy/test/docker-compose.yml run --rm -u root tests"
        }, {
            sh "docker-compose -p citydynamics -f web/deploy/test/docker-compose.yml down"
        }
    }
